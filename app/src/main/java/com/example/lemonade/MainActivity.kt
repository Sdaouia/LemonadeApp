...
class MainActivity : AppCompatActivity() {
    ...
    private fun setViewElements() {
        ...
        when (lemonadeState) {
            ...
            /*SELECT -> getResources().getString(R.string.lemon_select)
               SQUEEZE -> getResources().getString(R.string.lemon_squeeze)
               DRINK -> getResources().getString(R.string.lemon_drink)
               else -> getResources().getString(R.string.lemon_empty_glass)
       }
        textAction.setText(info_text)*/
